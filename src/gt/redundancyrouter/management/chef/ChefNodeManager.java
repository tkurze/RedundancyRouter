package gt.redundancyrouter.management.chef;
...
import gt.redundancyrouter.management.chef.knife.KnifeController;
import gt.redundancyrouter.management.chef.knife.KnifeController.KnifeControllerException;
import gt.redundancyrouter.management.chef.knife.KnifeController.KnifeOperatingSystem;
	...
	public String bootstrapNode(String chefNodeName, NodeMetadata node,
		...
		try {
			...
			if (this.useRemoteKnife) {
				...
				if (useIdentityFile) {
					gt.redundancyrouter.utils.Utils.copyFileToHost(new File(
